#!/usr/bin/env python3
"""
Generate professional HTML documentation from README.md
Reads version dynamically from version.properties
"""
...
# Read README (excluding footer section)
...
# Create professional HTML with logo and version
html_document = f"""<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Coding Legion - Documentation v{version}</title>
    <style>
...
<body>
    <div class="header">
        <img src="{logo_base64}" class="logo" alt="Coding Legion Logo">
...
print(f"3. Save as: CodingLegion_Documentation_v{version}.pdf")
